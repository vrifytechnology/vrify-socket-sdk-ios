...
//
//        beforeEach {
//            let mockTransport = URLSessionTransportMock()
...
//
//                expect(presence.channel?.getBindings("presence_state")).to(beEmpty())
//                expect(presence.channel?.getBindings("presence_diff")).to(beEmpty())
//                expect(presence.channel?.getBindings("custom_state")).to(haveCount(1))
//                expect(presence.channel?.getBindings("custom_diff")).to(haveCount(1))
//            })
//
...
//                                payload: newState,
//                                ref: "1")
//                let list = presence.list(by: listByFirst)
...
//                                ref: "2")
//
//                let list2 = presence.list(by: listByFirst)
//                expect(list2).to(haveCount(1))
//                expect(list2[0]["id"] as? Int).to(equal(2))
//                expect(list2[0]["phx_ref"] as? String).to(equal("2"))
//            })
//
...
//                let transform1 = transform(presence.pendingDiffs[0]["leaves"]!, and: leaves)
//                expect(transform1.lhs).to(equal(transform1.rhs))
//
...
//                expect(list[0]["id"] as? Int).to(equal(1))
//                expect(list[0]["phx_ref"] as? String).to(equal("1"))
//                expect(presence.pendingDiffs).to(beEmpty())
//
...
//                let list2 = presence.list(by: listByFirst)
//                expect(list2).to(haveCount(1))
//                expect(list2[0]["id"] as? Int).to(equal(1))
//                expect(list2[0]["phx_ref"] as? String).to(equal("1"))
//
//                channel.trigger(event: "presence_state",
//                                payload: ["u1": user1, "u3": user3],
//                                ref: "")
//                let list3 = presence.list(by: listByFirst)
//                expect(list3).to(haveCount(1))
//                expect(list3[0]["id"] as? Int).to(equal(3))
//                expect(list3[0]["phx_ref"] as? String).to(equal("3"))
//
//            })
//
...
//
//                let transform1 = transform(state, and: stateBefore)
//                expect(transform1.lhs).to(equal(transform1.rhs))
//
//                state = Presence.syncState(state, newState: newState)
//                let transform2 = transform(state, and: newState)
//                expect(transform2.lhs).to(equal(transform2.rhs))
//            })
//
...
//                let transform = transform(state, and: stateBefore)
//                expect(transform.lhs).to(equal(transform.rhs))
//
//                state = Presence.syncState(state, newState: newState,
//                                           onJoin: onJoin, onLeave: onLeave)
//                let transform2 = transform(state, and: newState)
...
//                state = Presence.syncState(state, newState: newState,
//                                           onJoin: onJoin, onLeave: onLeave)
//                let transform = transform(state, and: newState)
//                expect(transform.lhs).to(equal(transform.rhs))
//
//                // assert equality in joined
...
//                let transform = transform(state, and: joins)
//                expect(transform.lhs).to(equal(transform.rhs))
//            })
//
...
//                ]
//
//                let transform = transform(state, and: expectation)
//                expect(transform.lhs).to(equal(transform.rhs))
//            })
//
